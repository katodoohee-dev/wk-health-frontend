...
export const PAGE_CONTRACTS: Record<string, PageContract> = {
  '/home': { title: 'Health Overview', eyebrow: 'HEALTH · DAILY STATUS', api: ['/api/stats/today', '/api/water/today', '/api/checkin/today'] },
  ...
  '/music': { title: 'Recovery Audio', eyebrow: 'MUSIC · SESSION', api: ['/api/music'] },
  '/stats': { title: 'Health Statistics', eyebrow: 'STATS · WEEKLY METRICS', api: ['/api/stats/today', '/api/stats/weekly', '/api/stats/week-summary'] },
  '/assistant': { title: 'WK Health Assistant', eyebrow: 'INTELLIGENCE · ASSISTANT', api: ['/api/assistant'] },
  ...
  '/gallery': { title: 'Health Media Library', eyebrow: 'MEDIA · IMAGE & VIDEO', api: ['/api/gallery/upload'] },
  '/friends': { title: 'Health Social', eyebrow: 'SOCIAL · FRIENDS', api: ['/api/friends/location/status', '/api/friends/location/share'] },
  ...
  '/notifications': { title: 'Health Alerts', eyebrow: 'ACCOUNT · NOTIFICATIONS', api: ['/api/notifications'] },
  '/vision': { title: 'Health Vision', eyebrow: 'VISION · PRESENTATION', api: ['/api/stats/today', '/api/diary'] },
