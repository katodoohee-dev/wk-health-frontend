            ...
            <div className="mx-auto mb-3 w-full max-w-md px-4">
              <div className="glass-strong relative grid grid-cols-5 items-center rounded-[1.75rem] px-2 py-2 shadow-soft">
                ...
                <div className="relative grid place-items-center">
                  <Link to="/scan" aria-label="สแกนอาหาร" className="press bg-mint-gradient absolute -top-9 grid size-16 place-items-center rounded-[1.35rem] text-primary-foreground shadow-glow">
