...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({ meta: [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1, viewport-fit=cover" }, { title: "WK Health App — ตรวจแคลอรีจากรูปอาหาร" }, { name: "description", content: "แอปสุขภาพ สแกนแคลอรีจากรูปอาหาร พร้อมไดอารี สถิติ ผู้ช่วย AI และนับก้าวเดิน" }, { name: "theme-color", content: "#111111" }, { property: "og:title", content: "WK Health App — ตรวจแคลอรีจากรูปอาหาร" }, { property: "og:description", content: "สแกนอาหาร รู้แคลอรีทันที พร้อมไดอารี สถิติ และผู้ช่วย AI" }, { property: "og:type", content: "website" }, { name: "twitter:card", content: "summary_large_image" }], links: [{ rel: "stylesheet", href: appCss }, { rel: "preconnect", href: "https://fonts.googleapis.com" }, { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" }, { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Outfit:wght@400;500;600;700;800&family=Noto+Sans+Thai:wght@400;500;600;700&display=swap" }, { rel: "icon", href: "/favicon.ico", type: "image/x-icon" }] }),
