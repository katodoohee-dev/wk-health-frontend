...
export const Route=createRootRouteWithContext<{queryClient:QueryClient}>()({
  head:()=>({meta:[{charSet:'utf-8'},{name:'viewport',content:'width=device-width, initial-scale=1'},{title:'WK Health — AI Health Operating System'},{name:'description',content:'WK Health is a monochrome, editorial health operating system: readiness, activity, guidance and voice in one calm interface.'},{name:'author',content:'WK Health'},{property:'og:title',content:'WK Health — AI Health Operating System'},{property:'og:description',content:'Readiness, recovery, activity and guidance in one calm interface.'},{property:'og:type',content:'website'}]}),
