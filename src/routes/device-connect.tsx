...
export const Route = createFileRoute("/device-connect")({
  head: () => ({
    meta: [
      { title: "เชื่อมต่ออุปกรณ์ — Weeker" },
      { name: "description", content: "เชื่อมต่อข้อมูลสุขภาพและ wearable เข้ากับ Weeker" },
    ],
  }),
